...
Abstraktion auf das Allgemiene
...
Widerholbarkeit und Überprüfbarkeit der Ergebnisse des Experiments.

Besitmmung quantitativer Aussagen durch Messungen.
...
Man muss Vektoren addieren, wenn mehrere Bewegungen auftritt.

Beispiel: Die Geschwindigkeit eines Bootes in einem fließenden Fluss
ist in echt die Vektorsumme aus v_Boot und v_Fluss.  Ein Wasserstrahl.

Beispiel: Um weit zu werfen, kommt es auf den Anlauf und auf den
Abwurfwinkel an.
...
** Ebbe und Flut
Ebbe und Flut treten zwimal am Tag auf.  Die Anziehungskraft der
Mondmasse verursacht die eine Flut.

Die Fliehkraft erzeugt die zweite Flut.  Da das Paar Erde/Mond nicht
um den Erdmittelpunkt, sondern das gemeinsame Gravitationßentrum
kreist.
...
** Die schiefe Drehachse als Grund für unsere Jahreßeiten
...
umgebende Luft.  Die benötigte Verdampfungswärme entzieht der der
Umgebung (Haut) Wärme.
